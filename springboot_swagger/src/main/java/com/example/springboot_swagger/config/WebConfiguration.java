...
/*
addInterceptors方法里面需要按自己情况进行修改，excludePath集合add的是需要放行的接口路径，前几章整合了swagger，所以此处需要放行swagger相关
的路径，swagger-ui.html、doc.html、swagger-resources、等等，你再加上自己想要放行的接口路径即可，一般是首页请求的接口以及登录注册的接口
（不需要进行token效验的接口）
*/
@Configuration
...
//                .allowedOrigins("*")
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        excludePath.add("/Demo/jinDuTiao"); // 测试websocket
